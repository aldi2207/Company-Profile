...
<div class="relative isolate px-6 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div
                class="bg-amber-300 relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
        ...
        <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="about"
                    class="rounded-md bg-amber-300 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-amber-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                    started</a>
                <a href="artikel" class="text-sm/6 font-semibold text-gray-900">Learn more <span
